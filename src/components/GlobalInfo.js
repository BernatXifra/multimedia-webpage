  ...
  return (
    <div className="globalInfo">
      <div className="globalInfo-video">
        ...
        <video controls width="100%" poster={process.env.PUBLIC_URL + "/multimedia-files/girona-poster.jpg"}>
          <source src={process.env.PUBLIC_URL + "/multimedia-files/girona-video.mp4"} type="video/mp4" />
          Video not working
        </video>
      ...
      <div className="globalInfo-audio">
        <div className="audio-card">
          ...
          <audio controls>
            <source src={process.env.PUBLIC_URL + "/multimedia-files/himne-gironafc.mp3"} type="audio/mp3" />
          </audio>
